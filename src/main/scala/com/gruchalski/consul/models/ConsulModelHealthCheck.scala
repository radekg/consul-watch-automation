...
case class ConsulModelHealthCheck(val node: String,
                                  val checkId: String,
                                  val name: String,
                                  val status: String,
                                  val notes: String,
...
case class ConsulModelHealthCheckService(val id: String,
                                         val service: String,
...
case class ConsulModelServiceHealthCheck(val node: ConsulModelNode,
